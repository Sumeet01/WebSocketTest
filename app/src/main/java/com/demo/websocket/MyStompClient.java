...
public class MyStompClient {
    ...
    private static final String TAG = ua.naiksoftware.stomp.client.StompClient.class.getSimpleName();

    public static final String SUPPORTED_VERSIONS = "1.4";
    public static final String DEFAULT_ACK = "auto";

    private final String tag = ua.naiksoftware.stomp.client.StompClient.class.getSimpleName();
    ...
    private ua.naiksoftware.stomp.client.StompClient.Parser parser;
    ...
    public MyStompClient(ConnectionProvider connectionProvider) {
        ...
        resetStatus();
        parser = ua.naiksoftware.stomp.client.StompClient.Parser.NONE;
    }
     ...
     */
    public void setParser(ua.naiksoftware.stomp.client.StompClient.Parser parser) {
        this.parser = parser;
    }
    ...
    public Completable send(String destination, String data) {
        ...
        headers.add(new StompHeader("deviceId", "Kashish"));
