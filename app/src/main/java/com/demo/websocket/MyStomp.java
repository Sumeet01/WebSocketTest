...
public class MyStomp {
    ...
    public static MyStompClient over(@NonNull ua.naiksoftware.stomp.Stomp.ConnectionProvider connectionProvider, String uri) {
     ...
     */
    public static MyStompClient over(@NonNull ua.naiksoftware.stomp.Stomp.ConnectionProvider connectionProvider, String uri, Map<String, String> connectHttpHeaders) {
     ...
     * @return StompClient for receiving and sending messages. Call #StompClient.connect
     */
    public static MyStompClient over(@NonNull ua.naiksoftware.stomp.Stomp.ConnectionProvider connectionProvider, String uri, @Nullable Map<String, String> connectHttpHeaders, @Nullable OkHttpClient okHttpClient) {
        if (connectionProvider == ua.naiksoftware.stomp.Stomp.ConnectionProvider.JWS) {
        ...
        if (connectionProvider == ua.naiksoftware.stomp.Stomp.ConnectionProvider.OKHTTP) {
    ...
    private static MyStompClient createStompClient(ua.naiksoftware.stomp.ConnectionProvider connectionProvider) {
        return new MyStompClient(connectionProvider);
    }
